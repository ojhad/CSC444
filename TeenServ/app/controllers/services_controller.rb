class ServicesController < ApplicationController
	...
	def show
		...
		@teens = User.find_by_sql("SELECT * FROM USERS JOIN (SELECT USER_SKILLS.USER_ID FROM SERVICES JOIN USER_SKILLS ON #{@service.skill}=USER_SKILLS.SKILL_ID)a on a.user_id=users.id")
	end
